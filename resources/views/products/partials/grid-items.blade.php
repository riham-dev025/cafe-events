...
@empty
    ...
    <div class="col-span-full bg-white rounded-[2rem] border border-stone-100 p-16 text-center shadow-sm">
        ...
        <h3 class="text-xl font-bold text-espresso">No matches found!</h3>
        <p class="text-stone-500 text-sm mt-1 max-w-sm mx-auto">Try adjusting your search criteria or filters to find what you are looking for.</p>
    </div>
@endforelse